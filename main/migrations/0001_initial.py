# Generated by Django 5.2 on 2025-04-08 05:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[('Toplanyapti', 'Toplanyapti'), ('Yetib keldi', 'Yetib keldi'), ('Yetkazilmoqda', 'Yetkazilmoqda'), ('Topshirildi', 'Topshirildi')], default='Toplanyapti', max_length=50)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.propertytype')),
            ],
        ),
        migrations.CreateModel(
            name='SubCategory',
